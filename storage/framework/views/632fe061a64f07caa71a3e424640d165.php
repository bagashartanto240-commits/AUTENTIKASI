        ...
        <nav class="col-md-3 col-lg-2 d-md-block sidebar collapse text-white p-4 shadow-lg">
            <div class="position-sticky">
                ...
                <div class="text-center mb-5 pb-4 border-bottom border-secondary">
                    ...
                    <div class="mb-3">
                        <?php if(file_exists(public_path($userPhoto))): ?>
                            <img src="<?php echo e(asset($userPhoto)); ?>" class="rounded-circle border border-2 border-primary p-1" style="width: 70px; height: 70px; object-fit: cover;">
                        <?php elseif(file_exists(public_path($userPhotoPng))): ?>
                            <img src="<?php echo e(asset($userPhotoPng)); ?>" class="rounded-circle border border-2 border-primary p-1" style="width: 70px; height: 70px; object-fit: cover;">
                        <?php else: ?>
                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode(Auth::user()->name)); ?>&background=0D6EFD&color=fff" class="rounded-circle" style="width: 70px; height: 70px;">
                        <?php endif; ?>
                    </div>
                    <p class="small fw-bold mb-0 text-truncate px-2"><?php echo e(Auth::user()->name); ?></p>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-5 py-5">
            <div class="d-flex justify-content-between align-items-center mb-5">
                ...
                <span class="badge bg-white text-dark shadow-sm p-2 px-3 rounded-pill border">
                    <i class="bi bi-clock me-1 text-primary"></i> <?php echo e(date('l, d M Y')); ?>
                    ...
                    <div class="row g-0">
                        <div class="col-md-4 bg-light p-5 text-center border-end d-flex flex-column align-items-center justify-content-center">
                            <div class="avatar-container mb-4">
                                <?php if(file_exists(public_path($userPhoto))): ?>
                                    <img src="<?php echo e(asset($userPhoto)); ?>" class="rounded-circle avatar-circle">
                                <?php elseif(file_exists(public_path($userPhotoPng))): ?>
                                    <img src="<?php echo e(asset($userPhotoPng)); ?>" class="rounded-circle avatar-circle">
                                <?php else: ?>
                                    <div class="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center avatar-circle shadow-sm">
                                        <span class="fs-1 fw-bold"><?php echo e(substr(Auth::user()->name, 0, 1)); ?></span>
                                    </div>
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="col-md-8 p-5">
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-sm-8 info-value"><?php echo e(Auth::user()->name); ?></div>
                            </div>
                            <div class="row mb-4">
    <div class="col-sm-4 info-label">NIM</div>
    <div class="col-sm-8 info-value font-monospace text-primary">
        <?php echo e(Auth::user()->nim); ?> </div>
</div>

<div class="row mb-4">
    <div class="col-sm-4 info-label">Alamat Email</div>
    <div class="col-sm-8 info-value"><?php echo e(Auth::user()->email); ?></div>
</div>

                            <div class="row mb-4">
                                <div class="col-sm-4 info-label">Tempat Lahir</div>
                                <div class="col-sm-8 info-value"><?php echo e(Auth::user()->tempat_lahir ?? '-'); ?></div>
                            </div>

                            <div class="row mb-4">
                                <div class="col-sm-4 info-label">Tanggal Lahir</div>
                                <div class="col-sm-8 info-value">
                                    <?php echo e(Auth::user()->tanggal_lahir ? date('d F Y', strtotime(Auth::user()->tanggal_lahir)) : '-'); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 info-value text-muted small">#<?php echo e(str_pad(Auth::user()->id, 5, '0', STR_PAD_LEFT)); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
...
</html><?php /**PATH D:\bagashartanto.20236004\autentikasi\todo-app\resources\views/dashboard.blade.php ENDPATH**/ ?>