...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top border-bottom py-3">
        <div class="container">
            <a href="/" class="navbar-brand fw-bold fs-4">
                <?php echo e(config('app.name', 'App')); ?><span class="text-primary">.</span>
            </a>
            
            <div class="ms-auto d-flex align-items-center gap-3">
                <?php if(Route::has('login')): ?>
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-outline-primary rounded-pill px-4">Dashboard</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-decoration-none fw-medium text-dark">Login</a>
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="btn btn-primary rounded-pill px-4">Register</a>
                        <?php endif; ?>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
            ...
            <div class="row align-items-center min-vh-100 g-5">
                ...
                <div class="col-lg-6 order-1 order-lg-2 text-center">
                    <div class="hero-visual position-relative">
                        <img src="<?php echo e(asset('img/1.jpg')); ?>" alt="Hero Image" 
    ...
    <footer class="py-5 border-top bg-light">
        <div class="container d-md-flex justify-content-between align-items-center text-center text-md-start">
            <p class="mb-0 text-secondary">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. All rights reserved.</p>
...
</html><?php /**PATH D:\bagashartanto.20236004\autentikasi\todo-app\resources\views/welcome.blade.php ENDPATH**/ ?>